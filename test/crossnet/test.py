...
from models.mmoe import CrossNetModel
...
if __name__ == "__main__":
    ...
    config_file = '/Users/fabriszhou/PycharmProjects/tf-model/test/crossnet/deepfm_live.json'
    export_path = '/Users/fabriszhou/PycharmProjects/tf-model/test/crossnet/runs'
    pack_path = '/Users/fabriszhou/PycharmProjects/tf-model/test/crossnet'
    data_path = '/Users/fabriszhou/PycharmProjects/tf-model/test/crossnet/part-00000'


    input = ModelInputConfig.parse(config_file, pack_path, export_path)

    source_task_structs = [64, 32, 1]
    target_task_structs = [64, 32, 1]
    source_hidden_act = "relu",
    source_output_act = "sigmoid"
    target_hideen_act = 'relu'
    target_output_act = 'sigmoid'
    cin_layer = [2, 2]

    model = CrossNetModel(input, source_task_structs=source_task_structs, source_hidden_act=source_hidden_act, source_output_act=source_output_act, target_task_structs=target_task_structs,
                          target_hidden_act=target_hideen_act, target_output_act=target_output_act)

...
if __name__ == '__main__':
    ...
    with ctxt.strategy.scope():
        ...
        model = DeepFMModel(input, k, dnn_hidden_widthes, dnn_hidden_active_fn)

        optimizer = tf.keras.optimizers.Adam(args.lr)
        callbacks = [tf.keras.callbacks.EarlyStopping(monitor='val_auc', min_delta=0.002,patience=3)]

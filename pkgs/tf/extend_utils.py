...
#修正logits， 主要用于sampled softmax 损失
def sampling_prob_correction(logits, candidate_sampling_probability):
    """sampling probalility correction: corrects the input logits to account for candidate sampling probability"""
